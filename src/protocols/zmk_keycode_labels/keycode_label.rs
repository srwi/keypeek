...
mod tests {
    ...
    fn zmk_and_qmk_resolve_identical_base_keys() {
        ...
        let qmk_a = crate::protocols::qmk_keycode_labels::get_basic_layout_key(
        ...
        let qmk_1 = crate::protocols::qmk_keycode_labels::get_basic_layout_key(
        ...
        let qmk_mute = crate::protocols::qmk_keycode_labels::get_basic_layout_key(
    ...
    fn zmk_and_qmk_resolve_identical_modified_keys() {
        ...
        let qmk_shift_1 = crate::protocols::qmk_keycode_labels::get_advanced_layout_key(
        ...
        let qmk_ctrl_c = crate::protocols::qmk_keycode_labels::get_advanced_layout_key(
        ...
        let qmk_ralt_8 = crate::protocols::qmk_keycode_labels::get_advanced_layout_key(
        ...
        let qmk_ctrl_mute = crate::protocols::qmk_keycode_labels::get_advanced_layout_key(
